...
import 'package:contact_app/features/contact_info/presentation/widgets/action_buttons.dart';
import 'package:contact_app/features/contact_info/presentation/widgets/information_header.dart';
import 'package:contact_app/features/contact_info/presentation/widgets/information_row.dart';
import 'package:contact_app/shared/constants/app_constants.dart';
import 'package:flutter/material.dart';

class ContactInfoMainView extends StatefulWidget {
  ...
  @override
  State<ContactInfoMainView> createState() => _ContactInfoMainViewState();
}

class _ContactInfoMainViewState extends State<ContactInfoMainView> {
  ...
  ContactInfoModel _createContactInfoModel() {
  ...
  Widget build(BuildContext context) {
    ...
    final isCreateContactPage = infoPageType == ContactInfoPageType.withoutData;
    final enableEditing = isCreateContactPage ||
        widget.viewModel.contactInfoEditingStatus ==
            ContactInfoEditingStatus.active;
    final enableAcceptButton =
        isCreateContactPage ? !_isFirstNameEmpty : enableEditing;
        ...
        child: Column(
          children: [
            InformationHeader(
              ...
              enableEditButton: !enableEditing,
              onUpdateTapped: widget.cubit.changeEditingStatus,
              onDeleteTapped: () {
                Navigator.pop(context, true);
                widget.cubit.deleteContact();
              },
            ),
            ...
            ActionButtons(
              ...
              onAccept: () async {
                widget.cubit.setContact(_createContactInfoModel());
